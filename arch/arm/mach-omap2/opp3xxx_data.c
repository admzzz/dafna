...
#define OMAP3630_VDD_MPU_OPP100_UV		1140000
...
static struct omap_opp_def __initdata omap36xx_opp_def_list[] = {
	...
	OPP_INITIALIZER("mpu", "dpll1_ck", "mpu_iva", true,  600000000, OMAP3630_VDD_MPU_OPP100_UV), 	
       /* MPU OPP3 - OPP-Turbo */
	OPP_INITIALIZER("mpu", "dpll1_ck", "mpu_iva", true, 800000000, OMAP3630_VDD_MPU_OPP120_UV), 
	/* MPU OPP4 - OPP-SB */
	OPP_INITIALIZER("mpu", "dpll1_ck", "mpu_iva", true, 1100000000, OMAP3630_VDD_MPU_OPP1G_UV),
//    OPP_INITIALIZER("mpu", "dpll1_ck", "mpu_iva", true, 1100000000, OMAP3630_VDD_MPU_OPP1_1G_UV), 
